...
<nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top">
  <div class="container-fluid">
    <button class="d-block d-md-none" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent"
      aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    <a class="navbar-brand mx-sm-auto mx-lg-0" href="home">
      <img src="<c:url value='/images/logo-mixi.webp'/>" width="100" height="50" />
    </a>

    <div class="d-block d-md-none" style="margin-right: 14px;">
      <a href="cart"><img id="cart-icon" src="<c:url value='/images/cart.png'/>" alt="Giỏ hàng"></a>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Sản phẩm <img src="https://theme.hstatic.net/200000881795/1001243022/14/menu_icon_3.png?v=137" alt="Sản phẩm"
          ...
          <ul class="dropdown-menu">
            ...
            <c:if test="${empty listCategory}">
              <li><a class="dropdown-item" href="home">Không có danh mục nào</a></li>
            </c:if>
          </ul>
        </li>
      ...
      <div class="row">
          ...
          <div class="footer-block footer-click">
            <div class="" style="margin-bottom: 1rem;">
              <div class="single-contact">
                <div class="content">
                  <i class="fa fa-map-marker-alt"></i> Địa chỉ: <span>Yên Lãng, Hà Nội</span>
                </div>
              </div>
            </div>
            <div class="" style="margin-bottom: 1rem;">
              <div class="single-contact">
                <div class="content">
                  <i class="fa fa-mobile-alt"></i> Số điện thoại: <a class="link" title="0822221992" href="tel:0822221992"
            ...
            <div class="" style="margin-bottom: 1rem;">
              <div class="single-contact">
                <div class="content">
                  <i class="fa fa-envelope"></i> Email: <a title="Mixiishop@gmail.com" class="link" href="mailto:Mixiishop@gmail.com"
        ...
        <div class="col-lg-4 col-sm-12">
          <div class="footer-block footer-click">
            ...
            <ul class="list-menu toggle-mn" style="list-style-type: none; padding-left: 0;">
              <li class="li_menu" style="margin: 0;"><a class="link" href="home" title="Trang chủ" style="text-decoration: none;">Trang
                  chủ</a></li>
              <li class="li_menu" style="margin: 0;"><a class="link" href="about" title="Giới thiệu" style="text-decoration: none;">Giới
                  thiệu</a></li>
              <li class="li_menu" style="margin: 0;"><a class="link" href="contact" title="Liên hệ" style="text-decoration: none;">Liên
                  hệ</a></li>
            </ul>
          </div>
        </div>
