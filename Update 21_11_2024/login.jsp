					...
					<div class="card-body p-md-5">
						<div class="row justify-content-center">
							<div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
								...
								<p class="text-center h2 fw-bold mb-5 mx-1 mx-md-4 mt-4">Đăng nhập tài khoản</p>
								...
								<form class="mx-1 mx-md-4" method="POST" action="login">
									...
									<div class="d-flex flex-row align-items-center mb-4">
										...
										<div data-mdb-input-init class="form-outline flex-fill mb-0">
											<label class="form-label" for="form3Example1c">Tên người dùng:</label> <br>
									...
									<div class="d-flex flex-row align-items-center mb-4">
										...
										<div data-mdb-input-init class="form-outline flex-fill mb-0">
											<label class="form-label" for="form3Example4c">Mật khẩu:</label> <br>
							...
							<div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
								<img src="<c:url value='/images/mixicity.png'/>" class="img-fluid" alt="">
							</div>
						</div>
					</div>
				</div>
